...
<%@page import="in.gadgethub.dao.impl.*,in.gadgethub.dao.*,in.gadgethub.utility.*,java.util.*"%>
<%@page import="in.gadgethub.pojo.ProductPojo,in.gadgethub.dao.impl.ProductDaoImpl"%>
