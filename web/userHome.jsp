...
<%@page import="in.gadgethub.dao.impl.*,in.gadgethub.dao.*,in.gadgethub.utility.*,in.gadgethub.pojo.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*" %>
			...
			<div class="col-sm-4">
				<div class="thumbnail mt-3 mb-3">
					...
					<form method="post">
						...
						&nbsp;&nbsp;&nbsp;
						<button type="submit" formaction="./AddToCartServlet?uid=<%=userName%>&pid=<%=product.getProdId()%>&pqty=1&action=buy"
